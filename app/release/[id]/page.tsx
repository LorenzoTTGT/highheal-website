    ...
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <main className="p-4 md:p-6">
          {/* Artwork */}
          <div className="w-full aspect-square relative rounded-lg overflow-hidden mb-6 shadow-2xl">
            <Image
              src={release.artwork}
              alt={`${release.title} by ${release.artist}`}
              fill
        ...
        {/* Footer */}
        <footer className="bg-black border-t border-gray-800 p-4 text-center text-gray-500 text-sm">
